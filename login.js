// Login page script moved from the previous root script.js
// This handles login validation and redirects to the per-page menu modules.
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const ROLE_LANDING = {
        ...
        admin: "fieldDashboard",
        captain: "fieldDashboard"
    };
